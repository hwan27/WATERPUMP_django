...
const Pump4 = props => (
    <div className={styles.pumpBoxes}>
        ...
        <div className={styles.pumpBox}>
            <div className={styles.pump}>
            {props.sector.pump_4_on ?  (<img className={styles.pumpImg} src={pumpImg} alt="pumpImg"/>) : 
                (<img className={styles.pumpImg} src={pumpImgX} alt="pumpImg"/>)}
                <div className={styles.pumpTitle}>4번펌프</div>
            </div>
            <div className={styles.detail}>
            {props.sector.pump_4_auto ? <div className={styles.auto}>자동</div> : <div className={styles.manual}>수동</div>}
            
            <div className={styles.bottom}>
            <div className={styles.row}>
                <div className={styles.name}>가동률</div>
                <div className={styles.value}>{props.sector.pump_4_operating_rate} %</div>
            </div>

            <div className={styles.row}>
                <div className={styles.name}>전류</div>
                <div className={styles.value}>{props.sector.pump_4_current} A</div>
            </div>

            <div className={styles.row}>
                <div className={styles.name}>주파수</div>
                <div className={styles.value}>{props.sector.pump_4_freq} Hz</div>
            </div>

            <div className={styles.row}>
                <div className={styles.name}>전력</div>
                <div className={styles.value}>{props.sector.pump_4_power} kw</div>
            </div>
            </div>

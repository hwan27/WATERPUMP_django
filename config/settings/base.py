...
ROOT_DIR = environ.Path(__file__) - 3  # (waterpump/config/settings/base.py - 3 = waterpump/)
APPS_DIR = ROOT_DIR.path('waterpump')
...
MIGRATION_MODULES = {
    'sites': 'waterpump.contrib.sites.migrations'
}
